              ...
              <ul class="">
                ...
                <li>
                  ...
                  <ul>
                    <li>
                      <a href="#">
                        <i class="fa fa-university" aria-hidden="true"></i>3rd
                        Level #1
                      </a>
                      <ul>
                        <li>
                    ...
                    <li>
                      <a href="#">
                        <i class="fa fa-thumbs-up" aria-hidden="true"></i>3rd
                        Level #2
                      </a>
                    </li>
                    <li>
                      <a href="#">
                        <i class="fa fa-users" aria-hidden="true"></i>3rd Level
                        #3
                      </a>
                      <ul>
                        <li>
                        ...
                        <li>
                          <a href="#">
                            <i class="fa fa-print" aria-hidden="true"></i>4th
                            Level #2
                          </a>
                        </li>
                        <li>
                ...
                <div class="ruby-row">
                  ...
                  <div class="ruby-col-2 hidden-md">
                    ...
                    <ul>
                      ...
                      <li>
                        <a href="#">
                          <i class="fa fa-music" aria-hidden="true"></i>Menu
                          Item #2
                        </a>
                      </li>
                      <li>
                      ...
                      <li>
                        <a href="#">
                          <i class="fa fa-sliders" aria-hidden="true"></i>Menu
                          Item #4
                        </a>
                      </li>
                      <li>
                    ...
                    <div class="ruby-row">
                      <div class="ruby-col-4 ruby-col-6-md">
                        <ul>
                          <li>
                            <a href="#">
                              <i class="fa fa-star" aria-hidden="true"></i>Menu
                              Item
                            </a>
                          </li>
                          <li>
                          ...
                          <li>
                            <a href="#">
                              <i class="fa fa-send" aria-hidden="true"></i>Menu
                              Item
                            </a>
                          </li>
                          <li>
                            <a href="#">
                              <i class="fa fa-user" aria-hidden="true"></i>Menu
                              Item
                            </a>
                          </li>
                          <li>
                      ...
                      <div
                        class="ruby-col-4 ruby-col-6-md"
                      ...
                      <div
                        class="ruby-col-4 hidden-md"
                        style={{ paddingLeft: "15px" }}>
                        <ul>
                          <li>
                            <a href="#">
                              <i class="fa fa-map-o" aria-hidden="true"></i>Menu
                              Item
                            </a>
                          </li>
                          <li>
                            <a href="#">
                              <i class="fa fa-image" aria-hidden="true"></i>Menu
                              Item
                            </a>
                          </li>
                          <li>
                            <a href="#">
                              <i class="fa fa-legal" aria-hidden="true"></i>Menu
                              Item
                            </a>
                          </li>
                          <li>
                          ...
                          <li>
                            <a href="#">
                              <i class="fa fa-heart" aria-hidden="true"></i>Menu
                              Item
                            </a>
                          </li>
                        </ul>
                ...
                <ul class="ruby-menu-mega-blog-nav">
                    ...
                    <div
                      ...
                      <div class="ruby-row">
                        ...
                        <div class="ruby-col-3">
                          ...
                          <span class="ruby-c-content">
                            If you have ever said some of below idioms you are
                            for sure a smoking...
                          </span>
                        </div>
                        <div class="ruby-col-3">
                          ...
                          <span class="ruby-c-content">
                            When we think “philosopher,” a certain image comes
                            to mind—most often a wise...
                          </span>
                        </div>
                        <div class="ruby-col-3">
                          ...
                          <span class="ruby-c-content">
                            This is a list of serious injuries and deaths in
                            which the victim or a member of...
                          </span>
                        </div>
                      </div>
                    </div>
                      ...
                      <div class="ruby-row">
                        ...
                        <div class="ruby-col-4">
                          ...
                          <div class="ruby-col-7">
                            <span class="ruby-c-title">
                              <a href="#">
                                Bottle Labels: Short Stories To Read
                              </a>
                            </span>
                            <span class="ruby-c-category">
                              <a href="#">News / Culture</a>
                      ...
                      <div class="ruby-row">
                        ...
                        <div class="ruby-col-4">
                          ...
                          <div class="ruby-col-7">
                            <span class="ruby-c-title">
                              <a href="#">
                                10 Freaking Facts About Being A Pilot
                              </a>
                            </span>
                            <span class="ruby-c-category">
                              <a href="#">News / Life</a>
                        ...
                        <div class="ruby-col-4">
                          ...
                          <div class="ruby-col-7">
                            <span class="ruby-c-title">
                              <a href="#">
                                Health Benefits Of A Glass Of Whiskey
                              </a>
                            </span>
                            <span class="ruby-c-category">
                              <a href="#">News / Health</a>
                      ...
                      <div class="ruby-row">
                        <div class="ruby-col-6">
                          ...
                          <div class="ruby-col-8">
                            <span class="ruby-c-title">
                              <a href="#">
                                Nexo Created New Airless Bike Tires That Will
                                Never Get Flat
                              </a>
                            </span>
                            <div class="ruby-c-inline">
                      ...
                      <div class="ruby-row">
                        <div class="ruby-col-6">
                          ...
                          <div class="ruby-col-8">
                            <span class="ruby-c-title">
                              <a href="#">
                                Italian Pastry Chef Creates Miniature Worlds
                                With Desserts
                              </a>
                            </span>
                            <div class="ruby-c-inline">
                        ...
                        <div class="ruby-col-6">
                          ...
                          <div class="ruby-col-8">
                            <span class="ruby-c-title">
                              <a href="#">
                                Dogs Brought To The Lavender Gardens To Capture
                                Their Joy
                              </a>
                            </span>
                            <div class="ruby-c-inline">
                  ...
                  <li>
                    ...
                    <div
                      ...
                      <div class="ruby-row">
                        <div class="ruby-col-6">
                          <span class="ruby-c-title" style={{ marginBottom: "15px" }}>
                            POPULAR THREADS
                          </span>
                          <div class="ruby-row">
                          ...
                          <div class="ruby-row">
                            ...
                            <div class="ruby-col-11">
                              <span class="ruby-c-title">
                                <a href="#">
                                  Bottle Labels With Short Stories To Be Read Is
                          ...
                          <div class="ruby-row">
                            ...
                            <div class="ruby-col-11">
                              <span class="ruby-c-title">
                                <a href="#">
                                  10+ Stunning Animal Portraits That Has Been
                                  Filmed By Polyushko
                                </a>
                              </span>
                            </div>
              ...
              <ul>
                ...
                <li class="ruby-open-to-left">
                  ...
                  <ul>
                    ...
                    <li>
                      <a href="#">
                        <i class="fa fa-file" aria-hidden="true"></i>3rd Level
                        #4
                      </a>
                      <ul>
                        <li>
